...
const fireballScene: PackedScene = preload("res://scene/item/projectile/fireball.tscn")
...
func apply(attr_dict: Dictionary):
	...
	var damage = Damage.new(
		...
		attr_dict["player_attr_info"].damageBonus["Fire"],
...
func calculate_damage() -> float:
	return 20 + 0.5 * self.attrDict["player_attr_info"].spellPower.final_value()
